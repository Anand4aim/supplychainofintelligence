...
/framework is organized as SIX SECTIONS in this exact order: Definition (what is it?) → Map (where does value accrue? — 10 layers, 50 sublayers, Substrate/Workflow/Surface tiers, Three Currents) → Laws (why does it work? — 4 Laws) → Dynamics (how does it evolve? — 6 patterns + 6 archetypes) → Applications (how do I use it? — Triangle + Cube instruments + self-serve tools) → Observations (what's happening now? — pointers to /live, /predictions, /case-studies). Tier grouping: Substrate=L−1..L3+L8, Workflow=L4..L6, Surface=L7. Never use "Tier 0..4" or "Register" or "Knowledge Tiers" — retired. Cube and Triangle are INSTRUMENTS (section 5), never Laws.
