...
CANONICAL DEFINITION (verbatim, evergreen, never paraphrase): "Intelligence is a supply chain. Value accrues at the scarce, defensible nodes, not the most visible one." Three registers: Definition (evergreen, the sentence above) → Application (evergreen structure: 10 layers, 50 sublayers, 4 laws, 3 currents, Intelligence Cube) → Reading (living, monthly: company placements, verdicts, predictions). Source of truth: src/data/definition.ts + <CanonicalDefinition />. Surfaced on /, /framework, /paper, /methodology, /about, plus index.html noscript, llms.txt, humans.txt, framework-context.ts.
