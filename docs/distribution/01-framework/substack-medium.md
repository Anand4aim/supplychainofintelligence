# Substack / Medium — Article 1

**Title**: The Supply Chain of Intelligence — a 10-layer map of the generative AI stack
**Canonical URL** (set in post settings): `https://supplychainofai.com/framework`
**Cover image URL**: `https://supplychainofai.com/og/distribution/01-framework-cover.jpg`
**Tags**: `artificial-intelligence`, `product-strategy`, `generative-ai`, `tech-strategy`, `ai-stack`
...
![The Supply Chain of Intelligence — the 10 layers of the generative AI stack](https://supplychainofai.com/og/distribution/01-framework-cover.jpg)
...
The supply chain has 10 layers, numbered L−1 through L8. The numbering is deliberate: power, water, and fabs sit *below* silicon, so they get the negative index. Memory sits *outside* the inference path but compounds across it, so it gets the highest.
...
Each layer breaks further into 5 sublayers — 50 in total. The full map lives at [supplychainofai.com/framework](https://supplychainofai.com/framework). I'm keeping this piece at headline resolution.
...
The full framework — all 10 layers, 50 sublayers, 4 Laws, 3 Currents, Intelligence Cube, six archetypes — is published as an open standard at **[supplychainofai.com/framework](https://supplychainofai.com/framework)**.
