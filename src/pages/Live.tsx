        ...
        <div className="max-w-5xl mx-auto px-6 py-16">
          {loading ? (
            ...
            <div className="text-center py-20">
              <p className="text-muted-foreground mb-2">No articles yet — the first edition publishes Monday.</p>
              <p className="text-xs text-muted-foreground/70">(Or trigger the first one manually from the dashboard.)</p>
            </div>
          ) : (
