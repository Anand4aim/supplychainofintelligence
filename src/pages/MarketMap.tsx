  ...
  return (
    <SiteLayout>
      <Seo
        ...
        description="A visual map of where every notable AI company sits on Supply Chain of Intelligence™. Filter by vertical. Click any company for the structural read."
        path="/market-map"
      />
