...
export const POSTS: Post[] = [
  {
    ...
    title: "A Meta-Layer for VCs: How to Underwrite the AI Stack One Layer at a Time.",
    subtitle:
      "Most AI deal memos still argue about market size, team, and traction. The meta-question underneath, the one that decides whether the check compounds, is simpler and harder: which layer of the stack is this check actually buying, and is that layer structurally durable or structurally absorbed? This is the framework that sits above the memo.",
    excerpt:
      "Capital Flows is the third Current in the SCoI framework, the meta-layer that decides whether a defensible layer position compounds into a real business. The seed squeeze isn't a financing story; it's the market quietly repricing layers. This piece is for VCs: an underwriting lens that sits above the memo, sorts founders by the layer they're actually trying to own, and converts the four structural laws into a checklist a partner can use before the next IC.",
    ...
    kind: "opinion",
    body: [
      ">> Most AI memos argue about market, team, and traction. The meta-question is which layer the check is actually buying, and whether that layer is structurally durable or structurally absorbed. Every other question is downstream.",
      "Talk to enough partners and a pattern shows up. The arguments inside IC are still mostly about market size, founder pedigree, and early traction, the same arguments that have run venture for thirty years. None of those questions are wrong. They're just not the **meta-question**. The meta-question is which layer of the Supply Chain of Intelligence™ (SCoI) the check is underwriting, because that single answer changes the comp set, the round shape, the moat thesis, the exit math, and the failure mode all at once.",
      "This is a piece for VCs. Not a market take, not a manifesto, an underwriting lens that sits one layer above the deal memo and forces every other question into the right shape. Capital flows are not the same as value. They drift, they overshoot, they starve the unglamorous layers. The job is to read them through the layer map, not the round-size table.",
      "The framework calls this **Current III: Capital Flows**. Currents are not layers. They flow _across_ the ten layers, and they decide whether a defensible position compounds into a business or stays a beautifully diagrammed line item on a deck.",
      ...
      "**Law IV, Generation and Verification Must Be Separate.** In regulated verticals, do not fund the company trying to be both L2/L5 _and_ L3. It will lose to a focused L3 player above it (Vanta over AWS, Snyk over Copilot, audit over the system being audited). **Underwriting an integrated stack in a Law IV vertical is a category error, not a portfolio bet.** IC test: in any regulated category, ask explicitly whether the gate-owner is in the deal or above it. If the founder is trying to be both, the company is structurally short the gate-owner that will eventually appear.",
