...
export const POSTS: Post[] = [
  {
    ...
    excerpt:
      "Three forces are colliding: a founder tsunami driven by cheap-to-build AI products, a capital squeeze at seed, and a customer market that did not get cheaper to win. The companies that will compound through this cycle are the ones that own access (distribution, data pipes, surface placement) and acquisition (the unit economics of actually landing and keeping a customer). This piece is for VCs: a meta-layer for underwriting the AI stack one layer at a time, with access and acquisition as the load-bearing question.",
    ...
    kind: "opinion",
    body: [
      ">> Founder tsunami coming. Capital getting harder. Customers no cheaper to win. In that triangle, the new moat is not the product, it's **access** and **acquisition**, the layers that decide who can actually reach a buyer and convert one.",
      ...
      "The framework calls the underlying force **Current III: Capital Flows**. Currents are not layers. They flow _across_ the ten layers, and they decide whether a defensible position compounds into a business or stays a beautifully diagrammed line item on a deck.",
