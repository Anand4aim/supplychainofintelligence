...
const COMPANIES = Object.fromEntries([
  ...
  C("harvey", "Harvey", "Execution platform", "growth",
    ...
    "Primary L5a Domain Execution · Secondary L6b/L6c · Future moat L8d",
  ...
  C("legora", "Legora", "Execution platform", "growth",
    ...
    "Primary L5a Domain Execution · Secondary L6c · Future moat L8d",
  ...
  C("luminance", "Luminance", "Specialized model + execution", "growth",
    ...
    "Primary L2b Specialized Models · Secondary L5a",
  ...
  C("legalfly", "LegalFly", "In-house workspace", "early",
    ...
    "Primary L5a · Secondary L3c Safety & Security",
  ...
  C("norm", "Norm Ai", "Compliance / RegTech", "early",
    ...
    "Primary L3a Compliance Gates · Secondary L1b",
  ...
  C("parley", "Parley", "Immigration automation", "early",
    ...
    "Primary L5a Domain Execution (immigration)",
    "YC.",
...
export const LEGAL_MAP: VerticalMapData = {
  ...
  thesis:
    "Value is bifurcating to L5 Domain Execution at the top (Harvey, Legora) and L1 Data underneath (outcome data + proprietary corpora). At the early stage, L5a is already crowded — differentiation must come from a vertical data moat, not the workflow. The fundable open layers are L3a Compliance Gates, L1d / L8e litigation-outcome data, and the AI-native firm model.",
  whitespace: [
    ...
    { title: "L3a Compliance Gates.", body: "Norm Ai, Delve, Greenlite are early and few — an upstream, recurring, Bloomberg-shaped layer." },
  ...
  scorecard: [
    ...
    { sublayer: "L2b Specialized Models", occupants: "Luminance, Paxton", state: "mid" },
    { sublayer: "L3a Compliance Gates", occupants: "Norm Ai, Delve, Greenlite, Hadrius, Regbase", state: "open" },
    { sublayer: "L5a Domain Execution", occupants: "Harvey, Legora, EvenUp, Supio, Eve, Luminance, Ivo, Wordsmith, Definely, LegalFly, Lawhive, DeepIP, Patlytics, Solve, immigration trio", state: "contested" },
