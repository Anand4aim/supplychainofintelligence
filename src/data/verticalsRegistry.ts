...
export const VERTICAL_REGISTRY: VerticalEntry[] = [
  ...
  { slug: "sales-tech", label: "Sales Tech", blurb: "AI-native SDR, prospecting, dialers, meeting intel, deal execution, RevOps AI.", mapsTo: "sales", status: "live" },
  { slug: "sales-gtm", label: "Sales & GTM (broad)", blurb: "Marketing, ABM, CS/PLG, pricing, deal desk. Sibling to the Sales Tech map.", mapsTo: "sales", status: "coming-soon" },
