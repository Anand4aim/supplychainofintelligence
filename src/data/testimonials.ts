...
//
// All named people below have given permission to be listed. Quotes are
// drawn from workshops, 1:1 strategy reviews, and LinkedIn exchanges, and
// have been confirmed (or paraphrased with the speaker's consent) before
// publication. If a person prefers a different attribution, we update on
// request.
//
// `homepage: true` is reserved for the 4–5 strongest verified voices that
// surface on the home page strip. The full set lives on /voices.
